                    ...
                    <DialogContent className="sm:max-w-106.25">
                      ...
                      <form onSubmit={(e) => e.preventDefault()} className="space-y-4 pt-2">
                        ...
                        <DialogFooter className="pt-4 gap-2 sm:gap-0">
                          <button type="button" onClick={() => { setSetorSelecionado("todos"); setOrdenacao("nenhum"); }} className="px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 active:bg-gray-50 rounded-lg cursor-pointer hover:dark:text-zinc-300 active:dark:bg-zinc-800 dark:text-zinc-500">
                            Limpar
                          </button>
